...
class GoalCompletedEventListenerTest {
    ...
    private GoalCompletedEventDto event;
    ...
    void setup() {
        ...
        event = GoalCompletedEventDto.builder()
                .userId(1)
                .goalId(2)
    ...
    void testOnMessage() throws IOException {
        ...
        when(objectMapper.readValue(jsonProjectFollowerEvent.getBytes(), GoalCompletedEventDto.class)).thenReturn(event);
        ...
        verify(objectMapper).readValue(message.getBody(), GoalCompletedEventDto.class);
