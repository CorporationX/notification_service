...
class MentorshipAcceptedEventListenerTest {
    ...
    void onMessageSuccessfully() throws Exception {
        ...
        MentorshipAcceptedEvent event = new MentorshipAcceptedEvent(1L,"Request",2L,"John",3L);
        ...
        byte[] body = "{\"mentorshipRequestId\":1,\"description\":\"Request\",\"receiverId\":2,\"receiverUserName\":\"John\",\"requesterId\":3}".getBytes(StandardCharsets.UTF_8);
