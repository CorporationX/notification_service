...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, FollowerEvent> followerEventConsumerFactory() {
        ...
        config.put(JsonDeserializer.VALUE_DEFAULT_TYPE, FollowerEvent.class.getName());

        return new DefaultKafkaConsumerFactory<>(
                config,
                new StringDeserializer(),
                new JsonDeserializer<>(FollowerEvent.class)
        );
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, FollowerEvent> followerEventKafkaListenerContainerFactory() {
