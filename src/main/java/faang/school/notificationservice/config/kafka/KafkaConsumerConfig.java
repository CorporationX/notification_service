...
public class KafkaConsumerConfig {
    ...
    private String host;
    @Value("${spring.kafka.group.follower-event}")
    ...
    public Map<String, Object> consumerConfigs() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, follower_group);
        return props;
    }
    ...
    @Bean
    public ConsumerFactory<Long, FollowerEvent> consumerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, Object> kafkaTemplateForSend() {
