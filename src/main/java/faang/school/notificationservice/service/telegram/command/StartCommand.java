...
public class StartCommand extends Command {
    ...
    public SendMessage execute(CommandDto commandDto) {
        ...
        SendMessage message = initMessage(greetings, commandDto.getChatId(), commandDto.getFirstName());

        log.info("Reply sent to chat - {}", commandDto.getChatId());
        return message;
    }

    private SendMessage initMessage(String messageText, long chatId, String firstName) {
