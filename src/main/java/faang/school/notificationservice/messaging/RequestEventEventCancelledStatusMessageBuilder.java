...
public class RequestEventEventCancelledStatusMessageBuilder implements RequestEventEventStatusMessageBuilder {

    private final MessageSource messageSource;

    @Override
    public boolean isApplicable(RequestEventEvent event) {
        return event.requestStatus() == RequestStatus.READY;
    }
