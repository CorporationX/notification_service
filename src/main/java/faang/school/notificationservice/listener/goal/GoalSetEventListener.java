...
import faang.school.notificationservice.dto.goal.GoalSetEvent;
...
@Slf4j
@Component
public class GoalSetEventListener extends AbstractEventListener<GoalSetEvent> {

    public GoalSetEventListener(
    ...
    public void onMessage(Message message, byte[] pattern) {
        ...
        handleEvent(message, GoalSetEvent.class, event -> {
